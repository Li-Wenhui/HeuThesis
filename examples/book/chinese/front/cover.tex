...
\heusetup{
  ...
  % 中文信息
  %=========
  ctitleone={船用低速双燃料发动机},%本科生封面使用
  ctitletwo={控制策略研究及仿真分析},%本科生封面使用
  ctitlecover={船用低速双燃料发动机控制策略研究及仿真分析},%放在封面中使用，自由断行
  ctitle={船用低速双燃料发动机控制策略研究及仿真分析},%放在原创性声明中使用
  ...
  %
  % 关键词用“英文逗号”分割
  ckeywords={\TeX, \LaTeX, CJK, thesis, 模板},
