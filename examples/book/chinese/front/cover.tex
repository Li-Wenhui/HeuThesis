...
\heusetup{
  ...
  % 中文信息
  %=========
  ctitleone={基于~\LaTeX~的哈尔滨工程大学本硕博论文模板},%封面使用
  ctitletwo={使用说明},%封面使用
  ctitlecover={基于~\LaTeX~的哈尔滨工程大学本硕博\\论文模板使用说明},%放在封面中使用，自由断行
  ctitle={基于~\LaTeX~的哈尔滨工程大学本硕博论文模板使用说明},%放在原创性声明中使用
  ...
  cauthor={马冬梅},
  csupervisor={孔夫子\ 教授},
  cprofessional={教授}, % 职称，本科毕业设计内封
  %cassosupervisor{孔乙己\ 副教授},  %辅导师（如果有）
  ccosupervisor={丹丘生\ 研究员}, % 专业学位企业导师/联合导师
  ...
  % 英文信息
  %=========
  etitle={Manual of~ \LaTeX ~Thesis Template of\\ Harbin Engineering University},
  esubtitle={This is the sub title},
  exueke={Engineering},
  esubject={Power Engineering},
  ...
  %eassosupervisor={Professor KONG Yiji}, %辅导师（如果有）
  ecosupervisor={Professor DAN Qingsheng}, %企业导师名称（英文）
  % 日期自动生成，若需指定按如下方式修改：
  % edate={December, 2017},
