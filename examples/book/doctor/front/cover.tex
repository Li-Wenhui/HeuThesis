...
\heusetup{
  ...
  % 中文信息
  %=========
  ctitlecover={船用低速双燃料发动机控制策略\\研究及仿真分析},%放在封面中使用，自由断行
  ctitle={船用低速双燃料发动机控制策略研究及仿真分析},%论文中使用
  ...
  %ccosupervisor={某某某 教授},     % 联合指导老师，不需要可注释掉
  %creviewer={岑夫子\ 教授},        %论文主审人，不需要可注释掉
  ...
  eaffil={College of Power and Energy Engineering}, %学院名称（英文）
  eauthor={Ma Dongmei},    %作者名称（英文）
  esupervisor={KONG Fuzi}, %导师名称（英文）
  eassosupervisor={DAN Qingsheng}, %企业导师名称（英文）
  % 日期自动生成，若需指定按如下方式修改：
  % edate={December, 2017},
